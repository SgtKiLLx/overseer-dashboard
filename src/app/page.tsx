      ...
      <main className="flex-1 p-6 lg:p-12 max-w-[1600px] mx-auto w-full pt-24 lg:pt-12 transition-all duration-500">
        ...
        {activeTab === "intelligence" && (
          <div className="space-y-12 animate-in fade-in slide-in-from-bottom-2 duration-700">
            <header>
                <h2 className="text-3xl lg:text-5xl font-[1000] text-white tracking-tighter leading-[0.85]">Hello,<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-500 uppercase tracking-tighter italic">{session.user?.name}</span></h2>
